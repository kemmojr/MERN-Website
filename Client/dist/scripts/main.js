...
/* harmony default export */ var divWithClassName = (className => /*#__PURE__*/react.forwardRef((p, ref) => /*#__PURE__*/(0,jsx_runtime.jsx)("div", { ...p,
  ref: ref,
...
var bootstrap_min = __webpack_require__(4666);
...
var bootstrap_min_update = injectStylesIntoStyleTag_default()(bootstrap_min/* default */.Z, bootstrap_min_options);
       ...
       /* harmony default export */ var css_bootstrap_min = (bootstrap_min/* default */.Z && bootstrap_min/* default.locals */.Z.locals ? bootstrap_min/* default.locals */.Z.locals : undefined);
...
var App_App = /*#__PURE__*/function (_Component) {
  ...
  function App(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "handleChange2", function (event) {
      _this.setState({
    ...
    _defineProperty(_assertThisInitialized(_this), "submit", function () {
      axios_default().post('/api/insert', _this.state).then(function () {
        alert('success post');
      });
    ...
    _defineProperty(_assertThisInitialized(_this), "remove", function (id) {
      if (window.confirm("Do you want to delete? ")) {
        axios_default()["delete"]("/api/delete/".concat(id));
        document.location.reload();
      }
    });

    _defineProperty(_assertThisInitialized(_this), "edit", function (id) {
      axios_default().put("/api/update/".concat(id), _this.state);
      document.location.reload();
    });
  ...
  _createClass(App, [{
    ...
    value: function componentDidMount() {
      ...
      axios_default().get("/api/get").then(function (response) {
        _this2.setState({
    ...
    value: function render() {
      ...
      var card = this.state.fetchData.map(function (val, key) {
        return /*#__PURE__*/react.createElement(react.Fragment, null, /*#__PURE__*/react.createElement(esm_Card, {
          style: {
            width: '18rem'
          },
          className: "m-2"
        }, /*#__PURE__*/react.createElement(esm_Card.Body, null, /*#__PURE__*/react.createElement(esm_Card.Title, null, val.book_name), /*#__PURE__*/react.createElement(esm_Card.Text, null, val.book_review), /*#__PURE__*/react.createElement("input", {
          name: "reviewUpdate",
          onChange: _this3.handleChange2,
        ...
        }, "Update"), /*#__PURE__*/react.createElement(react_bootstrap_esm_Button, {
          onClick: function onClick() {
            _this3.delete(val.id);
          }
        }, "Delete"))));
      });
      return /*#__PURE__*/react.createElement("div", {
        className: "App"
      }, /*#__PURE__*/react.createElement("h1", null, "Dockerized Fullstack React Application"), /*#__PURE__*/react.createElement("div", {
        className: "form"
        ...
        variant: "primary",
        onClick: this.submit
      }, "Submit"), " ", /*#__PURE__*/react.createElement("br", null), /*#__PURE__*/react.createElement("br", null), /*#__PURE__*/react.createElement(esm_Container, null, /*#__PURE__*/react.createElement(esm_Row, null, card)));
    }
  }]);
...
react_dom.render( /*#__PURE__*/react.createElement(src_App_0, null), document.getElementById('root'));
...
/******/ __webpack_require__.O(0, ["common"], function() { return __webpack_exec__(9581); });
